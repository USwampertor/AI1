...
void Boid2D::Update()
{
	m_position2d += Arrive(m_EnemyPosition);
	m_position2d += Wander(1.6f);
	m_body.setPosition(IDVtoSFML(m_position2d));
}
...
XVECTOR2 Boid2D::Wander(float fVisionAngle)
{
